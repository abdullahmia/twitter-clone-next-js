...
const Post = ({id, post, postPage}) => {
  ...
  return (
    <div className="p-3 flex cursor-pointer border-r border-gray-700"  onClick={() => router.push(`/${id}`)}>
        {
            !postPage && (
                <img src={post?.userImg} className="h-11 w-11 rounded-full mr-4" alt="Profile" />
            )
        }
